...
#define GE_PROFILE 1
    ...
    #define GE_PROFILE_BEGIN_SESSION(name, filepath) ::GE::Instrumentor::Get().BeginSession(name, filepath)
    #define GE_PROFILE_END_SESSION() ::GE::Instrumentor::Get().EndSession()
    #define GE_PROFILE_SCOPE(name) ::GE::InstrumentationTimer timer##__LINE__(name);
    #define GE_PROFILE_FUNCTION() GE_PROFILE_SCOPE(HZ_FUNC_SIG)
#else
