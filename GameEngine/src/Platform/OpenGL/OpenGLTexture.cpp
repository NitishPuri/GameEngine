...
GE::OpenGLTexture2D::OpenGLTexture2D(uint32_t width, uint32_t height)
...
GE::OpenGLTexture2D::~OpenGLTexture2D()
{
    GE_PROFILE_FUNCTION();
...
void GE::OpenGLTexture2D::SetData(void * data, uint32_t size)
{
    GE_PROFILE_FUNCTION();
...
void GE::OpenGLTexture2D::Bind(uint32_t slot) const
{
    GE_PROFILE_FUNCTION();
